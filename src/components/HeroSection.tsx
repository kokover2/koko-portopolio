  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-hero py-20">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center lg:text-left flex-1 py-6 justify-items-center">
              <motion.div
        ...
        {/* Container Flex: Kolom di HP, Baris di Desktop */}
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-20 max-w-6xl mx-auto">
          ...
          <motion.div 
            ...
            transition={{ duration: 0.8 }}
          >
            {/* Dekorasi Bingkai Bercahaya */}
            <div className="absolute -inset-1 bg-gradient-to-r from-primary to-purple-600 rounded-2xl blur opacity-30 animate-pulse"></div>
            
            <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-2xl overflow-hidden border-4 border-white/10 shadow-2xl glass">
              <img 
                src="/kokorof.jpg" // Ganti dengan path foto Anda di folder public
                alt="Koko Rofenso"
          ...
          <div className="text-center lg:text-left flex-1">
            ...
            >
              Saya adalah seorang web enggineer dengan pengalaman dalam membangun aplikasi web modern menggunakan React, Next.js, dan teknologi terkait. Saya selalu mencari tantangan baru untuk meningkatkan keterampilan saya dan menciptakan solusi inovatif.
            </motion.p>
            ...
            >
              {[
                { icon: Github, href: 'https://github.com/kokover2/koko-portopolio.git', label: 'GitHub' },
